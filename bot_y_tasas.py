...
# ---------------------------------------------------------------------
SUPABASE_URL = os.environ.get("https://ojrsytqozoxymwayuanb.supabase.co/rest/v1/")
SUPABASE_SERVICE_KEY = os.environ.get("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9qcnN5dHFvem94eW13YXl1YW5iIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODQ1MDMyMzYsImV4cCI6MjEwMDA3OTIzNn0.yhk_u2pAjvIl9kk8d8IEq1JXGv2Y5MHRhuiyVdrO5bg")
TELEGRAM_BOT_TOKEN = os.environ.get("8611888956:AAEt87-LcGIuu6L0Q4BY78C2jpyRAo8pBNc")
TELEGRAM_CHAT_ID = os.environ.get("8049098989")
